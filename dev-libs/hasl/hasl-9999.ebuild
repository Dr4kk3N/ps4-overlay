...
DESCRIPTION="The Hassle-free Authentication and Security Layer client library"
...
if [[ ${PV} = *9999* ]] ; then
	...
	SRC_URI="https://bitbucket.org/hasl/hasl/downloads/${P}.tar.xz"
...
RDEPEND="
	...
	gtk? ( >=gui-libs/gtk-4.10.4:4[introspection?] )
	lua? (
		dev-lua/lgi
