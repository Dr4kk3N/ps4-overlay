...
IUSE="X aalib alsa debug doc gnome heif javascript jpeg2k jpegxl lua mng openexr postscript python test udev unwind vala vector-icons webp wmf xpm"
REQUIRED_USE="
...
COMMON_DEPEND="
	...
	>=media-libs/babl-0.1.108[introspection,lcms,vala?]
