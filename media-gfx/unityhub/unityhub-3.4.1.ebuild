...
#SRC_URI="https://hub.unity3d.com/linux/repos/deb/pool/main/u/unity/unityhub_amd64/${PN}_${PV}-beta.1_amd64.deb"
#SRC_URI="https://hub-dist.unity3d.com/artifactory/hub-debian-prod-local/${PN}_${PV}-beta.1_amd64.deb"
