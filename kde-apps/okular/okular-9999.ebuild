...
DEPEND="
	>=dev-qt/qtbase-${QTMIN}:6=[X,dbus,gui,widgets,cups]
	...
	pdf? ( >=app-text/poppler-21.10.0[nss,qt6] )
...
"
RDEPEND="${DEPEND}
	image-backend? ( >=kde-frameworks/kimageformats-${KFMIN}:6 )
	qml? (
...
src_configure() {
	local mycmakeargs=(
		...
		-DFORCE_NOT_REQUIRED_DEPENDENCIES="KF6DocTools;CHM;KF6KHtml;LibZip;KF6Wallet;DjVuLibre;EPub;KF6KExiv2;Discount;QMobipocket;Poppler;JPEG;LibSpectre;KF6Purpose;Qt6TextToSpeech;TIFF;"
		-DOKULAR_UI=$(usex qml "both" "desktop")
		$(cmake_use_find_package crypt KF6Wallet)
		$(cmake_use_find_package djvu DjVuLibre)
		$(cmake_use_find_package epub EPub)
		$(cmake_use_find_package image-backend KF6KExiv2)
