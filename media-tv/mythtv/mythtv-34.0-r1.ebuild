...
IUSE+=" +lame lcd libass lirc nvdec opengl vulkan oss perl pulseaudio python raw systemd vaapi vdpau vpx"
IUSE+=" +wrapper x264 x265 +xml xmltv +xvid +X qt5 +qt6 zeroconf"
...
RDEPEND="
	...
	qt6? (
		dev-qt/qtbase:6=[dbus,gui,widgets,network,sql,xml]
	)
